...
document.getElementById("mobil").onclick = function() {
    document.getElementById("varovani").innerHTML="Bohužel hra ještě není optimalizovaná pro mobil.";
}
...
document.getElementById("koupitTravu").onclick = function() {
    let more = document.body;
    more.filter="saturate(100) hue-rotate(180deg)";
}
...
document.getElementById("jitDoObchodu").onclick = function() {
    ...
    prestan = new Audio("hudbaObchod.mp3");
    if (pauza!=true) {
    prestan.play();
    prestan.volume=0.4;
    prestan.addEventListener('ended', function() {
